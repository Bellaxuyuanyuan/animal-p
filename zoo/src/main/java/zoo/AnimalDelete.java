...
public class AnimalDelete extends javax.swing.JFrame {
    ...
    /**
     * @param evt the action event of this text field
     */
    private void jTextField1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextField1ActionPerformed
    }//GEN-LAST:event_jTextField1ActionPerformed
    /**
     * This go back to Main.
     *
    ...
    /**
     * A button action perform to delete animal by inserting animal code. This
     * link connects to database with username and password. Shows message if
     * delete animals successful. Handle SQLException by showing error message
     * if inputs are wrong.
     *
     * @param evt the action event of this button
     */
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AnimalDelete().setVisible(true);//This window keep open.
            }
        });
    }
    /**
